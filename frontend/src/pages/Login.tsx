    ...
    <div className="relative w-full h-screen overflow-hidden bg-[#fafaf9]">
          ...
          <div className="fixed inset-0 pointer-events-none z-[9999]">
            {cursorParticles.map((particle) => (
              <motion.div
                ...
                className="absolute w-1.5 h-1.5 rounded-full bg-[#ff6392] shadow-[0_0_8px_#ff6392] blur-[0.5px]"
                style={{ left: 0, top: 0 }}
              />
            ))}
          </div>
      ...
      {!loading && (
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4" style={{ zIndex: 20, pointerEvents: 'none' }}>
          ...
          >
            <h1 className="text-[56px] sm:text-[64px] md:text-[72px] tracking-tight mb-2 font-display">
              <AnimatedTitle />
            </h1>
            <p className="text-center text-[14px] sm:text-[16px] text-[#666666] tracking-wide">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full flex items-center justify-center gap-3 sm:gap-4 bg-white px-8 sm:px-10 py-5 sm:py-6 rounded-full shadow-lg hover:shadow-xl border border-black/5 transition-all"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[12px] sm:text-[13px] text-[#999999]">or</span>
              <div className="flex-1 h-px bg-black/10" />
            </div>
            ...
            <div className="flex items-center justify-center gap-3 sm:gap-4">
              ...
              >
                <Apple className="w-5 h-5 sm:w-6 sm:h-6 text-[#666666] group-hover:text-[#1a1a1a] transition-colors" />
              </motion.button>
            ...
            <p className="text-[11px] sm:text-[13px] text-[#999999] text-center">
